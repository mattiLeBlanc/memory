...
function renderBoard() {
    ...
    deck.forEach((card) => {
        ...
        back.innerHTML = `<span><svg class="h-auto w-auto" width="42" height="42" viewBox="0 0 60 60" preserveAspectRatio="xMinYMin meet" fill="none" xmlns="http://www.w3.org/2000/svg">
